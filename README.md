## RBOX: A Spatial Index Library

### Features

* Dynamic RTree
* K-Nearest Neighbors Search for RTree. Implements a simple depth-first kNN search algorithm using a priority queue.
* Points Cluster.Implements huge points cluster using RTree.
